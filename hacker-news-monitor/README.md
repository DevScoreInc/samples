...
With this example you can monitor for a keyword and get an alert on your Slack channel. Create a CronJob with this function to continuously monitor Hacker News.
